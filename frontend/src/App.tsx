    ...
    <div className="min-h-screen bg-[#f7fafc] text-slate-900">
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-white via-[#fff4e9] to-[#ffe3c7] pb-24">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-8 lg:py-12">
          <header className="flex items-center justify-between gap-4 rounded-full bg-white/70 px-4 py-2 shadow-sm backdrop-blur">
            <div className="flex items-center gap-3">
              <div className="h-11 w-11 rounded-full bg-[url('/CP_logo.png')] bg-cover bg-center bg-no-repeat shadow-lg ring-4 ring-white/70" />
              <div>
                <p className="m-0 text-xs font-semibold uppercase tracking-[0.2em] text-orange-700">
                  Semester Sync [Tool]
                </p>
                <p className="m-0 text-sm text-gray-500">One-click semester scheduling</p>
              </div>
            </div>
            <div className="hidden items-center gap-4 text-sm text-gray-800 sm:flex">
              ...
              <a className="hover:text-gray-900" href="#sync">
                Sync
              </a>
          ...
          <div className="mt-12 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-7">
              ...
              <h1 className="m-0 text-4xl font-semibold leading-tight text-slate-900 sm:text-5xl">
          ...
          <div className="grid w-full max-w-[1120px] grid-cols-[minmax(0,1.05fr)_minmax(0,1.1fr)] overflow-hidden rounded-[18px] bg-white shadow-[0_24px_70px_rgba(15,23,42,0.2)] max-[900px]:grid-cols-1">
            <div className={`${panelPadding} bg-white`}>
              <header className="mb-7 flex items-center gap-4">
                <div className="relative h-[60px] w-[60px] shrink-0 rounded-full bg-[url('/CP_logo.png')] bg-cover bg-center bg-no-repeat" />
                <div>
